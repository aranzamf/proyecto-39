...
function preload(){
  ...
  obstacle1 = loadImage("carro1.png");
  obstacle2 = loadImage("carro2.png");
  obstacle3 = loadImage("carro3.png");
  obstacle4 = loadImage("carro1.png");
  obstacle5 = loadImage("carro2.png");
  obstacle6 = loadImage("carro3.png");
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   camera.position.y = trex.y -10;
    ...
    //if(keyDown(LEFT_ARROW)){camera.position.x = trex.x -2}
